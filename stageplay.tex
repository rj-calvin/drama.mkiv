...
\setuphead[covertitle][page=no, textstyle=cap, style={\tf\bf}, before={}, after={}]
...
\define[0]\maketitlepage{
	\vbox{
		\godown[3in]
		\covertitle{\getvariable{titlepage}{title}}

		\doiftext{\getvariable{titlepage}{subtitle}}{
			\coversubtitle{\getvariable{titlepage}{subtitle}}
		}

		\blank[2*line]
		\author{By \getvariable{titlepage}{author}}
	}
}

\definestartstop[castpage][
	before={\break\subject{\labeltext{cast}}\blank[3*line]}
]
