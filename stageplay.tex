...
\starttypescript[courierten]
	\definetypeface[courierten][rm][serif][courierten][default]
\stoptypescript

\setupbodyfont[courierten, 12pt]
...
\setuphead[act][
	...
	conversion=I,
	style={\tf\WORD},
	before={\blank\testpage[3]\hskip 2in},
	after={\blank}
]
...
\setuphead[speaker][
	...
	style={\tf},
	textstyle=cap,
	before={\doifmodeelse{simultaneousblock}{\hskip 1in}{\hskip 2in}},
	after={}
]
...
\setupparagraphs[simultaneous][1][width={\glueexpr 0.5\textwidth - 0.5\bodyfontsize\relax}]
\setupparagraphs[simultaneous][2][width={\glueexpr 0.5\textwidth - 0.5\bodyfontsize\relax}]
...
\startsetups[stage:dialog:before]
	\startnarrow[left={\doifmodeelse{simultaneousblock}{0.5in}{1.5in}}][left]
	\startblock
	(
\stopsetups
...
\define[0]\theend{
	\setupfootertexts[\hskip 2in\WORD\labeltext{theend}][]
}
